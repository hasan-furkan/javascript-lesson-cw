...
//   liste.innerHTML += `<li>${lessonList[i].name}</li>`;
// }
...
// const mdnLink = mdn.getAttribute("href")
// console.log(mdnLink);
// mdn.setAttribute("href", "https://www.w3schools.com/python/default.asp");
...
cwElm = document.createElement("p");
console.log(cwElm);
